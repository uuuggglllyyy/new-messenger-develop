...
urlpatterns = [
    ...
    path('upload-multiple/<int:chat_id>/', views.upload_multiple_files, name='upload_multiple_files'),
    path('upload-voice/<int:chat_id>/', views.upload_voice, name='upload_voice'),
